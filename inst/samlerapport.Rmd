...
params:
  ...
  bins: 5
title: Samlerapport
subtitle: en eksempelrapport fra nyre
author: Rapporteket
userFullName: Tore Tester
registryName: SKDE
reglogo: '`r system.file("logo.png", package = "nyre")`'
regtext: '`r readLines(system.file("shortDescription.txt", package = "nyre"))`'
...
f <- nyre::makeSimpleHist(df = mtcars, var = params$var, bins = params$bins, makeTable = FALSE)
```
